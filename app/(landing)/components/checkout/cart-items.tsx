...
const CartItems = ({handlePayment}: TCartItems) => {
    ...
    return (
        <CardWithHeader title="Cart Items">
            <div className="flex flex-col justify-between h-full h-[calc(100%-70px)]">
                ...
                <div key={item._id} className="border-b border-gray-200 p-4 flex gap-3">
                    <div className="bg-primary-light aspect-square w-16 flex justify-center items-center">
                        ...
                        width={63} height={63} alt={item.name} 
            ...
            <div className="border-t border-gray-200 p-4">
                ...
                <Button variant="dark" className="w-full mt-4" onClick={handlePayment}><FiCreditCard />Proceed to Payment</Button>
            </div>
            </div>
