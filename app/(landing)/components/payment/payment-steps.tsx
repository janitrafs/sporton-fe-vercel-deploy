...
const PaymentSteps = () => {
    ...
    const handleConfirmPayment = async () => {
        ...
        if (items.length === 0 || totalPrice <= 0) {
            ...
            push("/"); // redirect them back to shop
            return;
        }
        ...
        <CardWithHeader title="Payment Steps">
            <div className="p-5">
                <ol className="list-decimal text-xs pl-2 flex flex-col gap-4 mb-5">
                    <li>Transfer the total amount of <b>Rp. 1.035.000</b> to your preferred bank account listed under 'Payment Options' (BCA, Mandiri, or BRI).</li>
            ...
            <div className="border-t border-gray-200 p-4">
                ...
                <Button variant="dark" className="w-full mt-4" onClick={handleConfirmPayment}><FiCheckCircle />Upload Receipt & Confirm</Button>
            </div>
        </CardWithHeader>
    )
}
